...
public class Main {
	    ...
	    //Defining CompareValues explicitly so that we can sort the map in Descending Order
    public static class CompareValues implements Comparator<String> {

        HashMap<String, Integer> base;

        public CompareValues(HashMap<String, Integer> base) {
            this.base = base;
        }
    ...
    public static class TopTen_Reduce2 extends Reducer<IntWritable, Text, Text, IntWritable> {
        ...
        public  void reduce(IntWritable key, Iterable<Text> values,
            ...
            CompareValues bvc = new CompareValues(map);
